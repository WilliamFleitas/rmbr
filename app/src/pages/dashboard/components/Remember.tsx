  ...
  return (
    <div className="customBox container">
      <section className="section section-1">
        ...
        <div className="placeholder"><TiArrowSortedDown className="w-6 h-6"/></div>
      </section>
      ...
      <section className="section section-2">
        ...
        <div className="placeholder"><TiArrowSortedUp className="w-6 h-6"/></div>
      </section>
    </div>
  );
};
...
const Remember = () => {
  ...
  return (
    <article className='w-full flex flex-col'>
      ...
      <div>
        <button type="button" onClick={handlePingPongClick}>Asd</button>
      </div>
    </article>
  )
}
